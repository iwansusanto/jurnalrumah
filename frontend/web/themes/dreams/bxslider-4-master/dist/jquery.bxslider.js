		...
		var appendCaptions = function(){
			...
			slider.children.each(function(index){
				// get the image title attribute
                                var linkx = $(this).find('a:first').attr('href');
                                var namashowroom = $(this).find('a:first').data('nama');
                                var stokshowroom = $(this).find('a:first').data('stok');
				var title = $(this).find('img:first').attr('title');
                                var penulis = $(this).find('img:first').data('penulis');
                                
				// append the caption
				if(title !== undefined && ('' + title).length){
					$(this).append('<div class="bx-caption"><a href="' + linkx + '"><span>' + title + '</span></a></div>');
				}
                                if(penulis !== undefined && ('' + penulis).length){
					$(this).append('<div class="bx-penulis"><span>' + penulis + '</span></div>');
				}
                                if(namashowroom !== undefined && ('' + namashowroom).length){
					$(this).append('<div class="caption"><span class="namashowroom">' + namashowroom + '</span> <br /><span class="stokshowroom">Tersedia : ' + stokshowroom + ' Stock Mobil</span></div>');
				}
			});
		};
                
//                var appendPenulis = function(){
//			// cycle through each child
//			slider.children.each(function(index){
//				// get the image title attribute
//				var penulis = $(this).find('img:first').data('penulis');
